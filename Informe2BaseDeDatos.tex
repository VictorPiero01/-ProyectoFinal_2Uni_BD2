			...
			\newpage
						...
						\newpage
									\item Caso Registro Servicio de Vacunación
										...
										\begin{figure}[htb]
											\centering \includegraphics[width=8cm, height=4cm]{img/casosdeuso/registroservicio.png}
										\end{figure}
								
									\item Caso Registro Mantenimiento de Mascotas
									
										\begin{figure}[htb]
											\centering \includegraphics[width=8cm, height=4cm]{img/casosdeuso/registromantenimiento.png}
										\end{figure}
									
									
									\item Caso Registro Tratamiento de Mascotas
									
										\begin{figure}[htb]
											\centering \includegraphics[width=8cm, height=4cm]{img/casosdeuso/registrotratamiento.png}
										\end{figure}
						
						\newpage			
									
									\item Caso Registro Historial Clínico
									
										\begin{figure}[htb]
											\centering \includegraphics[width=8cm, height=4cm]{img/casosdeuso/registrohistorial.png}
										\end{figure}
									
									
									\item Caso Registro Agenda de Actividades
									
										\begin{figure}[htb]
											\centering \includegraphics[width=8cm, height=4cm]{img/casosdeuso/registroagenda.png}
										\end{figure}
								...
								\begin{figure}[htb]
									\centering \includegraphics[width=13cm, height=8cm]{img/arquitectura.jpg}
								\end{figure}
